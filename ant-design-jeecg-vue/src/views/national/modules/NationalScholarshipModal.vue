    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="姓名">
          <a-input placeholder="姓名" v-decorator="['baseRealName', validatorRules.baseRealName ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<!--        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="创建时间">
          <a-input placeholder="请输入创建时间" v-decorator="['ctime', validatorRules.ctime ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="修改时间">
          <a-input placeholder="请输入修改时间" v-decorator="['mtime', validatorRules.mtime ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="是否有效,标记删除">
          <a-input-number v-decorator="[ 'dr', validatorRules.dr ]" />
        </a-form-item>-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        ctime:{rules: [{ required: false, message: '请输入创建时间!' }]},
        mtime:{rules: [{ required: false, message: '请输入修改时间!' }]},
        dr:{rules: [{ required: false, message: '请输入是否有效,标记删除!' }]},
        },
        url: {
